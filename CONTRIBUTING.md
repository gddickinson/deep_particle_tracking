# Contributing to deep_particle_tracking
...
[GitHub issue](https://github.com/gddickinson/deep_particle_tracking/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the imaging modality, particle density, and whether you trained a new model or used a provided one.
